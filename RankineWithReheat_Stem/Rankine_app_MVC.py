...
class MainWindow(qtw.QWidget, Ui_Form):
    def __init__(self):
        ...
        self.InputWidgets = (self.pb_Optimize, self.rdo_Quality,  self.rdo_Quality_2, self.le_PHigh, self.le_PMid, self.le_PLow, self.le_TMid_max,
    ...
    def AssignSlots(self):
        ...
        self.le_TMid_max.editingFinished.connect(self.onTMaxMidChanged)
